...
public class RatingServiceTest {
    ...
    public void setup() {
        ...
        product1.setCategories(Set.of(ProductCategory.NES));
        ...
        product2.setCategories(Set.of(ProductCategory.NES));
    ...
    public void testCreateRating() {
        ...
        Optional<Rating> freshlyCreatedRatingOpt = ratingService.loadRating(product1.getId(), savedRating.getId());
